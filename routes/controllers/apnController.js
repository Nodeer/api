...
push_Driver = function(req, token, callback) 
{
    var note = new apns.Notification();
...
push_Client = function(req, token, callback) 
{
    var note = new apns.Notification();
    ...
    AM.findById(id,usertype,function(e, o) {
        if (!o) {
            ...
            for (var i = o.devices.iOS.length - 1; i >= 0; i--) {
                ...
                push_Driver(req.body,token,function(e, o) {
                    if (e) {
                        //retdata.msg = e;
                        //res.send(retdata, 400);
                    } else {
    ...
    AM.findById(id,usertype,function(e, o) {
        if (!o) {
            ...
            for (var i = o.devices.iOS.length - 1; i >= 0; i--) {
                //var request = req.body;
                var token = o.devices.iOS[i];
                push_Client(req.body,token,function(e, o) {
                    if (e) {
                        //retdata.msg = e;
                        //res.send(retdata, 400);
                    } else {
